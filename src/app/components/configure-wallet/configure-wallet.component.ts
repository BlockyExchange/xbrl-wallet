  ...
  async confirmWalletOverwrite() {
    ...
    try {
      const msg = this.walletService.isLedgerWallet()
        ? '<p class="uk-alert uk-alert-info"><br><span class="uk-flex"><span uk-icon="icon: info; ratio: 3;" class="uk-align-center"></span></span><span style="font-size: 18px;">You are about to configure a new wallet, which will <b>disconnect your Ledger device from Bault</b>.</span><br><br>If you need to use the Ledger wallet, simply import your device again.</p><br>'
